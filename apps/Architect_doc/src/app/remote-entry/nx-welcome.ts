      ...
      <div class="container">
        ...
        <div id="welcome">
          <h1>
            ...
            Welcome Architect_doc and hello from micro frontend 👋
          </h1>
          <input type="text" 
          placeholder="Type event to send to other microfrontends" [(ngModel)]="txtinput" />
        <button (click)="Send(txtinput)">Send Event</button>
        </div>
        <!--  HERO  -->
        <div id="hero" class="rounded">
          <div class="text-container">
            <h2>
              ...
              <span>You&apos;re up and running in architecture doc</span>
            </h2>
...
nx run-many -t build test lint</pre>
          ...
          <details>
            ...
            <pre>nx show project Architect_doc</pre>
          </details>
